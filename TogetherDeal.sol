...
contract TogetherDeal is Together{
   ...
   // ======== External: Buy =========
    ...
    function buy(uint256 _value, address _targetContract,string memory _tokenid,bytes calldata _calldata) external nonReentrant {
  ...
  function sell(uint256 _value, address _targetContract,string memory _tokenid,uint256 _expiresAt, bytes calldata _calldata) external nonReentrant {
  ...
  function cancle(uint256 _value,address _targetContract,string memory _tokenid,bytes calldata _calldata) external nonReentrant {
        require(step =3,"not active");
        require(allowList.allowed(_targetContract),"Not on AllowList");        
